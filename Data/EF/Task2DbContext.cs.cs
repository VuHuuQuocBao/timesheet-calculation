    ...
    public class Task2DbContext : DbContext
    {
        ...
        */
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseMySql("Server=localhost;User=root;password=;database=Task2;", ServerVersion.AutoDetect("Server=localhost;User=root;password=;database=Task2;"));
            //base.OnModelCreating(modelBuilder);
        }
